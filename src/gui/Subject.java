...
public class Subject extends javax.swing.JFrame {
    ...
    public void loadSubject(String text) {
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `Subject` WHERE `Subject`.`Subno` LIKE '" + text + "%' OR `Subject`.`Description` LIKE '" + text + "%' OR `Subject`.`Price` LIKE '" + text + "%'  ORDER BY `Subject`.`Subno` ;");
...
//    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1343, 757));
...
//        jPanel6.setBackground(clr);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ResultSet ssid = MySQL.search("SELECT * FROM `Subject` WHERE `Subno` = '" + sid + "'");
            ...
            if (r == -1) {
                ...
                if (ssid.next()) {
                    ...
                    if (description.isEmpty()) {
                        ...
                        MySQL.iud("UPDATE `Subject` SET `Description`= '" + description + "',`Price`='" + price + "' WHERE `Subno`= '" + sid + "' ");

                        loadSubject();
                        resetFields();

                        JOptionPane.showMessageDialog(this, "Subject Updated", "Success", JOptionPane.INFORMATION_MESSAGE);
