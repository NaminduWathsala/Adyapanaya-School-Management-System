...
public class Invoice extends javax.swing.JFrame {
    ...
    public void loadInvoice() {
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `Invoice` INNER JOIN `Student` ON `Student`.`Sno` = `Invoice`.`Sno` INNER JOIN `Teacher` ON `Teacher`.`Tno` = `Invoice`.`Tno` INNER JOIN `Subject` ON `Subject`.`Subno` = `Invoice`.`Subno`  ORDER BY `Student`.`Name` ASC ;");
    ...
    public void loadInvoice(String text) {
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `Invoice` INNER JOIN `Student` ON `Student`.`Sno` = `Invoice`.`Sno` INNER JOIN `Teacher` ON `Teacher`.`Tno` = `Invoice`.`Tno` INNER JOIN `Subject` ON `Subject`.`Subno` = `Invoice`.`Subno` WHERE `Student`.`Name` LIKE '" + text + "%' OR `Teacher`.`Name` LIKE '" + text + "%' OR `Subject`.`Description` LIKE '" + text + "%' OR `Invoice`.`month` LIKE '" + text + "%'   ORDER BY `Student`.`Name` ASC ;");
...
//    }
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student", "Teacher", "Subject", "Month", "Value"
            }
        ) {
        ...
        jButton1.setText("Register  Invoice");
        ...
        jButton2.setText("Select Student's Name");
        ...
        jButton3.setText("Select Teacher's Name");
        ...
        jButton4.setText("Select Subject Name");
        ...
        jLabel24.setFont(new java.awt.Font("Quicksand", 0, 18)); // NOI18N
        jLabel24.setText("None");

        jLabel25.setFont(new java.awt.Font("Quicksand", 1, 18)); // NOI18N
        jLabel25.setText("Name :");

        jLabel26.setFont(new java.awt.Font("Quicksand", 0, 18)); // NOI18N
        jLabel26.setText("None");

        jLabel27.setFont(new java.awt.Font("Quicksand", 1, 18)); // NOI18N
        jLabel27.setText("Birthday :");

        jLabel28.setFont(new java.awt.Font("Quicksand", 0, 18)); // NOI18N
        jLabel28.setText("None");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "January", "February", "March", "April", "May", "June", "July", "August", "September", "Octomber", "November", "December" }));
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                                        .addGap(18, 18, 18)
                                                        .addComponent(jLabel15, javax.swing.GroupLayout.DEFAULT_SIZE, 352, Short.MAX_VALUE))
                                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                                        .addGap(18, 18, 18)
...
//        jPanel7.setBackground(clr);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (stud.equals("None")) {
            ...
            JOptionPane.showMessageDialog(this, "Please Select a Value", "Warning", JOptionPane.WARNING_MESSAGE);

        } else {

            try {

                MySQL.iud("INSERT INTO `Invoice` (`Sno`,`Tno`,`Subno`,`month`,`Value`) VALUES ('" + stud + "','" + te + "','" + sub + "','" + month + "','" + value + "') ");
                loadInvoice();
...
//                String uniqueID = UUID.randomUUID().toString();
                ...
                String tename = jLabel15.getText();
                String stuname = jLabel26.getText();
                String subname = jLabel21.getText();

                JasperReport jr = JasperCompileManager.compileReport("src//reports//Adyapana.jrxml");

                HashMap parameters = new HashMap();
                parameters.put("Parameter1", stuname);
                parameters.put("Parameter2", tename);
                parameters.put("Parameter3", subname);
                parameters.put("Parameter4", month);
                parameters.put("Parameter5", value);
                parameters.put("Parameter6", value);
                parameters.put("Parameter7", str);
...
//        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        InvoiceStudents inc = new InvoiceStudents(this, true);
        inc.setVisible(true);
